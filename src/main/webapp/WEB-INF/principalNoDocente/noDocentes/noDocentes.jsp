...
<%
	LinkedList<NoDocente> noDocentes = (LinkedList<NoDocente>)request.getAttribute("noDocentes");
...
<body>
  ...
  <!-- Encabezado -->
    ...
    <!-- Contenido principal -->
        <div class="right">
            <form class="altaAlumno-form d-flex justify-content-end mb-3" action="filtrarNoDocente" method="post">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="modificarNoDocente?legajo=<%=a.getLegajo()%>" class="btn btn-primary">
                                <i class="bi bi-pencil-fill"></i>
                            </a>
                            <!-- Button trigger modal -->
                            <a href="bajaNoDocente?legajoDelete=<%=a.getLegajo()%>" class="btn btn-danger"> 
        ...
        <div class="left">
            <form class="altaAlumno-form" action="altaNoDocente" method="post">
